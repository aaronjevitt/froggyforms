...
<h4>Forms</h4>
<select style= class="form-control"  id='formSelect' name='formSelect' onClick="getFormSubmissions()"></select>
<h4>Submission:</h4>
...
<script>
    ...
    function getFormSubmission() 
    {
        ...
        document.getElementById("subnum").value = "";
        var formData = new FormData(form);
        formData.append("unique_url", value);
    ...
    function deletecurrentsubmission() 
    {
        ...
        var value = activeform.options[activeform.selectedIndex].value;
        var activesub = document.getElementById("submissionSelect");
        var sub = submissionMap.get(activesub.options[activesub.selectedIndex].value);
        var formData = new FormData(form);
        formData.append("unique_url", value);
